...
import LiveMarkdownEditor from './LiveMarkdownEditor.jsx';
...
function Workspace({ auth, onAuthChange }) {
  ...
  function insertMarkdown(before, after = '') {
    noteInput.current?.insertMarkdown(before, after);
  }
...
function HelpPage({onNavigate}){
 ...
 ['阅读与记录','顶部按钮可分别收起主侧栏和文献列表；F11 全屏，Esc 退出。“阅读”“笔记”“边读边记”切换单独阅读、独立写作和左右并排。Ctrl+S 保存，笔记在同一区域实时排版，停止输入约 1 秒自动保存。'],
